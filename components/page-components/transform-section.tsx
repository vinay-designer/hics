  ...
  return (
    <section className="relative min-h-screen py-24 overflow-hidden">
      ...
      <div className="absolute inset-0">
        <div className="absolute -top-1/4 -right-1/4 w-1/2 h-1/2 bg-blue-500/30 rounded-full blur-3xl opacity-20" />
        <div className="absolute -bottom-1/4 -left-1/4 w-1/2 h-1/2 rounded-full blur-3xl opacity-20" />
      </div>

      <div className="container mx-auto px-4 relative">
        <div className="flex flex-col gap-20">
          {/* Headline Section remains the same */}
            ...
            >
              <h2 className="text-8xl font-bold">
                <span className="relative inline-block">
                  <span className="relative z-10 bg-gradient-to-r from-violet-500 via-fuchsia-500 to-blue-500 bg-clip-text text-transparent">
                    Transform
                  </span>
                  <div 
                    ...
                    style={{
                      ...
                      ? `translateX(${(mousePosition.x / window.innerWidth) * 100 - 50}%)`
                      : 'translateX(-50%)',
              ...
              <div className="mt-8 flex items-center justify-center gap-4">
                <div className="h-px w-20 bg-gradient-to-r from-violet-500 to-blue-500" />
                <p className="text-gray-400 text-xl">Next-gen IT management</p>
                <div className="h-px w-20 bg-gradient-to-r from-blue-500 to-violet-500" />
              </div>
            </motion.div>
          </div>
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className="relative h-full">
                  <motion.div 
                    className="relative bg-black/20 backdrop-blur-sm border border-white/5 rounded-lg p-8 h-full
                             transition-all duration-300 group-hover:bg-black/30"
                    whileHover={{ y: -8 }}
                  ...
                  >
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="flex justify-between items-start">
                        <div className={`w-12 h-12 rounded-lg bg-gradient-to-r ${feature.gradient} p-[1px]`}>
                    ...
                    <div className={`absolute bottom-0 left-0 right-0 h-[1px] bg-gradient-to-r ${feature.gradient} 
                                   opacity-0 group-hover:opacity-100 transition-opacity duration-300`} />
                  </motion.div>

                  {/* Subtle Glow Effect */}
                  <div className={`absolute -inset-1 bg-gradient-to-r ${feature.gradient} opacity-0 
          ...
          >
            <Button 
              className="w-full bg-gradient-to-r from-violet-500 via-fuchsia-500 to-blue-500 text-white py-8 text-xl rounded-xl transition-all duration-500 group relative overflow-hidden"
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-violet-500 via-fuchsia-500 to-blue-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-xl" />
            </Button>
          </motion.div>
        </div>
      </div>
